...
class PartialRentalView extends StatefulWidget {
  const PartialRentalView({super.key});

  @override
  State<PartialRentalView> createState() => _PartialRentalViewState();
}

class _PartialRentalViewState extends State<PartialRentalView> {
  int currentPage = 1;
  int totalPages = 5;
  ...
  Widget build(BuildContext context) {
    final tabs = [
      S.of(context).allRooms('900'),
      S.of(context).singleRoomsOnly('200'),
      S.of(context).withEmptyBeds('600'),
      S.of(context).fullRooms('100'),
    ];
              ...
              ...List.generate(5, (index) {
                return TableRow(
                  children: [
                    ...
                    DataCell(text: S.of(context).shared, context: context),
                    DataCell(text: '1', context: context),
                    DataCell(text: '3', context: context),
                    Padding(
                      padding: const EdgeInsets.symmetric(
                        vertical: 8.0,
                        horizontal: 16,
